...
System.out.println(cardiologists[0] + ", " + cardiologists[1] + ", " + cardiologists[2]);
System.out.println(specialists[0] + ", " + specialists[1] + ", " + specialists[2] + ", " +specialists[3] + ", " + specialists[4] + ", " + specialists[5] + ", " + specialists[6]);
    }
}
