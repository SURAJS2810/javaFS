...
System.out.println(fiction[0] + ", " + fiction[1] + ", " + fiction[2]);
System.out.println(nonFiction[0] + ", " + nonFiction[1] + ", " + nonFiction[2]);
System.out.println(mystery[0] + ", " + mystery[1] + ", " + mystery[2]);
System.out.println(sciFi[0] + ", " + sciFi[1] + ", " + sciFi[2]);
System.out.println(fantasy[0] + ", " + fantasy[1] + ", " + fantasy[2]);
System.out.println(biography[0] + ", " + biography[1] + ", " + biography[2]);
System.out.println(selfHelp[0] + ", " + selfHelp[1] + ", " + selfHelp[2]);
System.out.println(classics[0] + ", " + classics[1] + ", " + classics[2]);
    }
}
