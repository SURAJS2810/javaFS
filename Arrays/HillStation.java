...
System.out.println(resortNames[0] + ", " + resortNames[1] + ", " + resortNames[2] + ", " + resortNames[3] + ", " + resortNames[4] + ", " + resortNames[5] + ", " + resortNames[6]);
System.out.println(rooms[0] + ", " + rooms[1] + ", " + rooms[2] + ", " + rooms[3] + ", " + rooms[4] + ", " + rooms[5] + ", " + rooms[6]);
System.out.println(activities[0] + ", " + activities[1] + ", " + activities[2] +", " + activities[3] + ", " + activities[4] +", " + activities[5] + ", " + activities[6]);
System.out.println(diningOptions[0] + ", " + diningOptions[1] + ", " + diningOptions[2] +", " + diningOptions[3] + ", " + diningOptions[4] +", " + diningOptions[5] + ", " + diningOptions[6]);
System.out.println(spaTreatments[0] + ", " + spaTreatments[1] + ", " + spaTreatments[2] +", " + spaTreatments[3] + ", " + spaTreatments[4] +", " + spaTreatments[5] + ", " + spaTreatments[6]);
System.out.println(views[0] + ", " + views[1] + ", " + views[2] +", " + views[3] + ", " + views[4] +", " + views[5] + ", " + views[6]);
    }
}
